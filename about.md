...
- [ELLIS Member](https://ellis.eu/), Delft unit
...
- _2015-2016_: a PostDoc at the computer vision lab of the EWI Faculty of TU Delft.
...
- _2010-2014_: PhD at the University of Amsterdam. Topic: automated analysis of pedestrian tracks, using probabilistic graphical models for unsupervised learning and online predictive Bayesian inference.
...
- _2013_: Research internship at the Environment Perception group of Daimler AG in Ulm, Germany (Mercedes Benz).
Worked on improved pedestrian path prediction for intelligent vehicles,
